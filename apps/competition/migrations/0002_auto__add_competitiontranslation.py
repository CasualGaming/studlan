...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompetitionTranslation'
        db.create_table('competition_competitiontranslation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', to=orm['competition.Competition'])),
            ('language', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('translated_title', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('translated_description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('competition', ['CompetitionTranslation'])


    def backwards(self, orm):
        # Deleting model 'CompetitionTranslation'
        db.delete_table('competition_competitiontranslation')
