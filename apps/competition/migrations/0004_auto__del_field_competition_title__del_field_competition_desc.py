...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Competition.desc'
        db.delete_column('competition_competition', 'desc')


    def backwards(self, orm):
        # Adding field 'Competition.title'
        db.add_column('competition_competition', 'title',
                      self.gf('django.db.models.fields.CharField')(default='Title', max_length=50),
                      keep_default=False)

        # Adding field 'Competition.desc'
        db.add_column('competition_competition', 'desc',
