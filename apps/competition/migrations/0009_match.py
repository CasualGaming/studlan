    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player1', models.ForeignKey(related_name='player1', to='competition.Participant', null=True, on_delete=models.CASCADE)),
                ('player2', models.ForeignKey(related_name='player2', to='competition.Participant', null=True, on_delete=models.CASCADE)),
                ('winner', models.ForeignKey(related_name='winner', to='competition.Participant', null=True, on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
