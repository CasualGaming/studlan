    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lottery', models.ForeignKey(to='lottery.Lottery', on_delete=models.CASCADE)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.ForeignKey(related_name='translations', verbose_name=b'lottery', to='lottery.Lottery', on_delete=models.CASCADE)),
            ],
            options={
                'abstract': False,
            },
