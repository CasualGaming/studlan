...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.ntnu_username'
        db.add_column('userprofile_userprofile', 'ntnu_username',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.ntnu_username'
        db.delete_column('userprofile_userprofile', 'ntnu_username')
    ...
    models = {
        ...
        'userprofile.userprofile': {
            ...
            'ntnu_username': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
