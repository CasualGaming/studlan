...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('competition_team', ['leader_id'])

        # Changing field 'Team.leader'
        db.alter_column('competition_team', 'leader_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'Team.leader'
        db.alter_column('competition_team', 'leader_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))

        # Adding unique constraint on 'Team', fields ['leader']
        db.create_unique('competition_team', ['leader_id'])
