...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Team.size'
        db.delete_column('competition_team', 'size')


    def backwards(self, orm):
        
        # Adding field 'Team.size'
        db.add_column('competition_team', 'size', self.gf('django.db.models.fields.CharField')(default=99, max_length=2), keep_default=False)
