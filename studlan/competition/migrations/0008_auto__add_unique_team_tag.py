...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Team', fields ['tag']
        db.create_unique('competition_team', ['tag'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Team', fields ['tag']
        db.delete_unique('competition_team', ['tag'])
