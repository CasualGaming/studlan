...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        competitions = orm.Competition.objects.all()

        for compo in competitions:
            teams = compo.teams.all()

            for old_team in teams:
                team = orm['team.Team'].objects.get(tag=old_team.tag)
                participant = orm.Participant()
                participant.team = team
                participant.competition = compo
                participant.save()

            users = compo.participants.all()
    ...
    complete_apps = ['team', 'competition']
