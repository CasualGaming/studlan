...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.lan'
        db.add_column('competition_competition', 'lan',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['lan.LAN']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.lan'
        db.delete_column('competition_competition', 'lan_id')
