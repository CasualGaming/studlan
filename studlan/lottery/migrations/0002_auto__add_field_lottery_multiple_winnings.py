...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lottery.multiple_winnings'
        db.add_column('lottery_lottery', 'multiple_winnings',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lottery.multiple_winnings'
        db.delete_column('lottery_lottery', 'multiple_winnings')
