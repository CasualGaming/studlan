...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Make a LAN entry for march 2012
        lan = orm.LAN()
        lan.title = 'studLAN 2012 - March 16.-18.'
        lan.start_date = datetime.datetime(2012, 03, 16, 19, 00, 00)
        lan.end_date = datetime.datetime(2012, 03, 18, 16, 00, 00)
        lan.location = 'P15, Gløshaugen, Trondheim.'
        lan.description = 'no description'
        lan.save()
    
        # Load all the userprofiles
        userprofiles = orm['userprofile.UserProfile'].objects.all()
        
        for profile in userprofiles:
            if profile.signed_up:
                attendee = orm.Attendee(user=profile.user, lan=lan, has_paid=profile.has_paid)
                attendee.save()
